...
import NounDeclensionNumberPractice from '../components/nounDeclensionNumberPractice'

export default class appNounDeclensionNumberPractice extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
