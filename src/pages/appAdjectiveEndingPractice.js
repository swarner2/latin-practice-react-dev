...
import AdjectiveEndingPractice from '../components/adjectiveEndingPractice'

export default class appAdjectiveEndingPractice extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
